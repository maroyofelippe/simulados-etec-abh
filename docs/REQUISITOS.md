...
| RF07a | Texto de apoio opcional (compartilhável entre várias questões, comum em Humanas) | ✅ |
| RF08 | Importação de questões via CSV (com agrupamento opcional por texto de apoio) | ✅ |
